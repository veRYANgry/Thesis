...
public class NEATSelfRegulationGene implements NEATGene, Cloneable {
   ...
   private double CompletionThreshold = 0; // used to determined if its time to
   // move to the Gene rules
   private int ThresholdType = 0; // describes the type of rule to determine
   // threshold
   ...
   private double maxPerturbRegulation;// max change that a value listed above
   // can change in one mutation
   ...
   public NEATSelfRegulationGene(
      int innovationNumber,
      NEATSelfRegulationGene linkForward,
      ...
      double pMutation,
      double pMutateBias,
      double pWeightReplaced,
      double maxPerturb,
      double maxBiasPerturb,
      double disjointCoeff,
      double excessCoeff,
      double weightCoeff,
      double threshold,
      int maxSpecieAge,
      int specieAgeThreshold,
      int specieYouthThreshold,
      double agePenalty,
      double youthBoost,
      ...
      double pMutatateRegulationMutation,
      double pMutatateRegulationAgeing,
      double maxPerturbRegulation,
   ...
   public NEATSelfRegulationGene clone() {
      return new NEATSelfRegulationGene(
         innovationNumber,
         linkForward,
         CompletionThreshold,
         ThresholdType,
         ...
         maxSpecieAge,
         specieAgeThreshold,
         specieYouthThreshold,
         agePenalty,
         youthBoost,
         survivalThreshold,
         pMutatateRegulation,
         pMutatateRegulationHueristics,
         pMutatateRegulationCoeff,
         pMutatateRegulationMutation,
         pMutatateRegulationAgeing,
         maxPerturbRegulation,
         Hueristics);
   }
   ...
   public double Difference(NEATSelfRegulationGene compareTo) {
      ...
      // totalDiff += Math.abs(this.maxSpecieAge - compareTo.maxSpecieAge) /
      // 10;

      totalDiff +=
         Math.abs(this.survivalThreshold - compareTo.survivalThreshold);
      totalDiff +=
         Math.abs(this.pMutatateRegulation - compareTo.pMutatateRegulation);
      totalDiff +=
         Math.abs(this.pMutatateRegulationHueristics
            - compareTo.pMutatateRegulationHueristics);
      totalDiff +=
         Math.abs(this.pMutatateRegulationCoeff
            - compareTo.pMutatateRegulationCoeff);
      totalDiff +=
         Math.abs(this.pMutatateRegulationMutation
            - compareTo.pMutatateRegulationMutation);
      totalDiff +=
         Math.abs(this.pMutatateRegulationAgeing
