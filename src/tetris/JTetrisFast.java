...
public class JTetrisFast extends JComponent {
	/**
	 * 
	 */
	...
	JTetrisFast(int width, int height) {
		super();
	...
	*/
	...
	/**
	 Creates a Window,
	 installs the JTetrisFast or JBrainTetrisFast,
	...
	*/
	...
	
	{
		...
		// Could create a JTetrisFast or JBrainTetrisFast here
		final int pixels = 16;
		JTetrisFast tetris = new JBrainTetrisFast(TetrisController.WIDTH*pixels+2, (TetrisController.HEIGHT+TetrisController.TOP_SPACE)*pixels+2);	
