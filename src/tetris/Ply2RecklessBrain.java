...
public class Ply2RecklessBrain implements Brain
{
	public BoardRater boardRater = new FinalRater();

	public Move bestMove(Board board, Piece piece, Piece nextPiece, int limitHeight) {
	  if(board.getMaxHeight()<board.getHeight()/2) return recklessMove(board, piece, nextPiece, limitHeight);
	...
	public Move recklessMove(Board board, Piece piece, Piece nextPiece, int limitHeight) {
		double bestScore = 1e20;
		int bestX = 0;
		int bestY = 0;
		Piece bestPiece = piece;
